	...
	public static void main(String args[]) throws Exception {
		...
		context.addRoutes(new RouteBuilder() {
			public void configure() {
				...
				.bean(DataFeedConsumer.class, "routeTo"); // send each crime to the main database, as well as to its city, year, month, crime category queue through a custom bean using a recipient list, also saving csv files to folders
			}
		});
